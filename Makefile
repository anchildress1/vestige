.PHONY: install bootstrap-wrapper build assemble test lint format ktlint-format ktlint-check secret-scan commitlint ci clean
...
test:
	$(GRADLE) :app:testDebugUnitTest :app:koverXmlReport
