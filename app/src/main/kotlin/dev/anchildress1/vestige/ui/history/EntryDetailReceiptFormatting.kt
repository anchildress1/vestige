...
internal fun buildFieldRows(entity: EntryEntity, repeatTitle: String?): List<FieldRow> {
    ...
    // REPEAT mirrors the Patterns-page H2 title for the strongest ACTIVE pattern this entry is in.
    // Deterministic — sourced from detection, never the model's recurrence read.
