...
/** `lensReceiptsJson` as a non-null JSON array — `"[]"` for null/blank legacy rows. */
val EntryEntity.lensReceiptsJsonOrEmpty: String
    get() = lensReceiptsJson?.trim()?.takeIf(String::isNotEmpty) ?: "[]"
