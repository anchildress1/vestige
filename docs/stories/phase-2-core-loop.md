...
| GPU sharpened | 2026-05-12 | GPU + greedy + sharpened lens framings + `maxAttemptsPerLens=3` | 15 | — | 49–309 s | **13/15 (87%) meaningful** | Best result. 8 entries with multi-axis divergence; 7 Skeptical flags fired with quoted evidence. C1 timed out at 5-min ceiling; D2 only 1/3 lenses parsed. Trade: ~1.8× mean latency for +27pp divergence and dramatically richer signal. Full archive: `docs/stt-results/stt-d-2026-05-12-gpu-sharp.md`. |

**GPU is now the multi-lens production default at 13/15 (87%) divergence.** ADR-002 §"Addendum (2026-05-12, second)" supersedes the earlier "default to CPU" verdict; the deterministic sampler closed the GPU parse-reliability gap. ADR-002 §"Addendum (2026-05-12, fourth)" records the sharpened-lens + 3-retry follow-up that took divergence from 60% to 87% with the latency / partial-parse trade-offs spelled out.
